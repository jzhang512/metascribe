...
def generate_metadata_batch(model_name: str, image_folder_path: str, json_schema: dict, output_file_path: str, **kwargs):
    ...
    with open(output_file_path, 'a') as f:
        for image_path in image_paths:
            ...
            cost = None
            try:
                response, elapsed_time, cost = generate_single_metadata(model_name, image_path, json_schema, **kwargs)
...
if __name__ == "__main__":
    ...
    for _ in range(1):
        response, _, _ = generate_single_metadata("gpt-4o-mini-2024-07-18", image_path, criteria, logprobs=True, top_logprobs=1)
